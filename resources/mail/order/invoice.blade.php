                ...
                <tr>
                  <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-line-height v-font-size"
                      ...
                      <p style="line-height: 140%;">
                      <p style="line-height: 19.6px;">{{ __('Ваши брони подтверждены, отправляем Вам инвойс') }} - <a href="{{ $invoice->fileUrl }}" target="_blank">по ссылке</a></p>
                      </p>
                      <p style="line-height: 140%;"> </p>
                    </div>
                  </td>
                ...
                <tr>
                  <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-line-height v-font-size"
                      ...
                      <p style="line-height: 140%;">
                        <span style="line-height: 18.2px;">{{ __('Номер инвойса: :id', ['id' => $invoice->number]) }}</span> 
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-line-height v-font-size"
                      style="font-size: 13px; line-height: 140%; text-align: left; word-wrap: break-word;">
                      <p style="line-height: 140%;">
                        <span style="line-height: 18.2px;">{{ __('Дата создания: :createdAt', ['createdAt' => $invoice->createdAt]) }}</span> 
                      </p>
                    </div>
                  </td>
                </tr>
