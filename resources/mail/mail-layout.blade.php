  ...
  <div class="mail-container">
    <div class="mail-row">
      <div class="mail-header">
        <img align="center" border="0" src="{{ site_url($path = 'images/logo.png') }}" alt="image" title="image"
        ...
        <div class="text-block m0">
          <p>
            <a href="mailto:{{ $manager->email }}" title="Почта" target="_blank"
              ...
              <img src="{{ site_url($path = 'images/mail.png') }}" alt="Почта" title="Почта" width="32"
            ...
            <a href="tel:{{ $manager->phone }}" title="Телефон" target="_blank" style="color: transparent !important;">
              <img src="{{ site_url($path = 'images/phone.png') }}" alt="Телефон" title="Телефон" width="32"
                style="outline: none;text-decoration: none;max-width: 32px !important" />
            </a>
          </p>
        </div>
