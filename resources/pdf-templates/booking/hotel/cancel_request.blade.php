                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td style="font-size: 24px; font-weight: bold; color: red"><b>{{ $booking->number }}</b></td>
                                <td class="text-align-right" colspan="2"><b>Дата и время отмены: {{ $booking->updatedAt }}</b></td>
                            </tr>
                            <tr>
                                <td>&ensp;</td>
                                <td>&ensp;</td>
