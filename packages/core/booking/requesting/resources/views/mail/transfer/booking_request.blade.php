...
@section('content')
    <div class="mail-content">
        ...
        <div class="text-block">
            <p>Просим Вас обработать <span class="new">запрос на бронирование</span> <span class="selected-text">во вложении</span></p>
        </div>
        ...
        <div class="text-block">
            ...
            <p>Просим <span class="selected-text">принять заказ</span> с Вашей стороны и сообщить в случае необходимости нашему менеджеру по бронированию.</p>
        </div>
    </div>
