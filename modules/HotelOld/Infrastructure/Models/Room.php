 ...
 * @property-read Collection|\Module\HotelOld\Infrastructure\Models\PriceRate[] $priceRates
 * @property-read Collection|\Module\HotelOld\Infrastructure\Models\Room\Bed[] $beds
...
class Room extends Model
{
    ...
    public function priceRates()
    {
        return $this->hasManyThrough(
            PriceRate::class,
            \Module\HotelOld\Infrastructure\Models\Room\PriceRate::class,
            'room_id',
            'id',
            'id',
            'rate_id'
