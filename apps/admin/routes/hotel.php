...
AclRoute::for('hotel')
    ...
    ->get('/{hotel}/settings', Controllers\Hotel\SettingsController::class . '@index', 'read', 'settings.index')
    ...
    ->get('/{hotel}/images', Controllers\Hotel\ImageController::class . '@index', 'read', 'images.index')
    ->get('/{hotel}/images/get', Controllers\Hotel\ImageController::class . '@get', 'read', 'images.get')
    ->post('/{hotel}/images/upload', Controllers\Hotel\ImageController::class . '@upload', 'update', 'images.upload')
    ->delete('/{hotel}/images/{image}', Controllers\Hotel\ImageController::class . '@destroy', 'delete', 'images.destroy')
    ->post('/{hotel}/images/reorder', Controllers\Hotel\ImageController::class . '@reorder', 'update', 'images.reorder')
    ->get('/{hotel}/images/{image}/rooms', Controllers\Hotel\ImageController::class . '@getImageRooms', 'get', 'images.rooms')
