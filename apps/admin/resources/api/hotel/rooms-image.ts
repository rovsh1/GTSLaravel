...
import { HotelRoomImageResponse, HotelRoomImage, mapHotelRoomsImageResponseToHotelRoomsImage } from '~api/hotel'
...
export const useHotelRoomsListWithAttachedImageAPI = (props: MaybeRef<HotelRoomsListWithAttachedImageProps | null>) =>
{ 
  return useAdminAPI(props, ({ hotelID, imageID }) =>
