...
export const useGetBookingAPI = (props: MaybeRef<GetBookingPayload>) =>
  useAdminAPI(props, ({ bookingID }) => `/transfer-booking/${bookingID}/get`)
    .get()
    .json<Booking>()
...
export const updateBookingStatus = (props: MaybeRef<UpdateBookingStatusPayload>) =>
  useAdminAPI(
    props,
    ({ bookingID }) => `/transfer-booking/${bookingID}/status/update`,
    { immediate: true },
  )
...
export const updateExternalNumber = (props: MaybeRef<UpdateExternalNumberPayload>) =>
  useAdminAPI(
    props,
    ({ bookingID }) => `/transfer-booking/${bookingID}/external/number`,
    { immediate: true },
  )
    .put(computed<string>(() => JSON.stringify(
...
export const updateNote = (props: MaybeRef<UpdateNotePayload>) =>
  useAdminAPI(
    props,
    ({ bookingID }) => `/transfer-booking/${bookingID}/note`,
    { immediate: true },
  )
    .put(computed<string>(() => JSON.stringify(
...
export const updateManager = (props: MaybeRef<UpdateManagerPayload>) =>
  useAdminAPI(
    props,
    ({ bookingID }) => `/transfer-booking/${bookingID}/manager`,
    { immediate: true },
  )
    .put(computed<string>(() => JSON.stringify(
...
export const copyBooking = (props: MaybeRef<CopyBookingPayload>) => {
  ...
  form.method = 'post'
  form.action = `/transfer-booking/${payload.bookingID}/copy`
  form.submit()
}
