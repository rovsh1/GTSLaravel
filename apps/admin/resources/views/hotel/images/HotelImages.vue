...
import { HotelImageResponse } from '~lib/api/hotel/images'
import { RoomImageResponse, useHotelImagesListAPI, useHotelRoomImagesAPI } from '~lib/api/hotel/images/list'
import { useHotelImageRemoveAPI } from '~lib/api/hotel/images/remove'
import { useHotelImagesReorderAPI } from '~lib/api/hotel/images/reorder'
import { useHotelRoomImageCreateAPI, useHotelRoomImageDeleteAPI } from '~lib/api/hotel/images/update'
import { useHotelImagesUploadAPI } from '~lib/api/hotel/images/upload'
import { HotelRoomResponse, useHotelRoomAPI } from '~lib/api/hotel/room'
