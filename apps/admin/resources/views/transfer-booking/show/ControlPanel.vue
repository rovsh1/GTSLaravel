...
import { useBookingRequestStore } from '~resources/views/transfer-booking/show/store/request'
import { useBookingStatusHistoryStore } from '~resources/views/transfer-booking/show/store/status-history'
...
import { updateBookingPrice } from '~api/booking/transfer/price'
