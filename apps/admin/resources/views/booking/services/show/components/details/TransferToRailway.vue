...
import { BookingTransferToRailwayDetails } from '~resources/views/booking/services/show/components/details/lib/types'
...
const bookingDetails = computed<BookingTransferToRailwayDetails | null>(() => bookingStore.booking?.details || null)
