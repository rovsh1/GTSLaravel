...
import { useExternalNumber } from '~resources/views/booking/hotel/show/composables/external-number'
import { useBookingStore } from '~resources/views/booking/hotel/show/store/booking'
import { useBookingRequestStore } from '~resources/views/booking/hotel/show/store/request'
import { useBookingStatusHistoryStore } from '~resources/views/booking/hotel/show/store/status-history'
...
import { externalNumberTypeOptions, getCancelPeriodTypeName, getHumanRequestType } from '~resources/views/booking/shared/lib/constants'

// import { useBookingVoucherStore } from '~resources/views/booking/hotel/show/store/voucher'
