  ...
  plugins: [
    laravel({
      input: [
        ...
        'resources/views/hotel/main/main.scss',
        ...
        'resources/views/hotel/quota-availability/quota-availability.ts',
        ...
        'resources/views/supplier-payment/main/main.ts',
        'resources/views/supplier-payment/main/main.scss',
        'resources/views/supplier-payment/form/form.ts',
        ...
        'resources/views/booking/services/main/main.scss',
        ...
        'resources/views/client-payment/main/main.ts',
        'resources/views/client-payment/main/main.scss',
        'resources/views/client-payment/form/form.ts',
