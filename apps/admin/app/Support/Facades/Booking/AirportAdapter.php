 ...
 * @method static int createBooking(int $cityId, int $clientId, int|null $legalId, int $airportId, int $serviceId, CarbonInterface $date, int $creatorId, ?int $orderId, ?string $note = null)
