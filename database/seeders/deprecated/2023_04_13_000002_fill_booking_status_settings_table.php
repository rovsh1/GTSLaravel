...
return new class extends Migration {
    ...
    public function up(): void
    {
        \DB::table('booking_status_settings')->insert([
            ...
            [
                'value' => BookingStatusEnum::INVOICED->value,
                'name_ru' => 'Выписан счет',
                'name_en' => null,
                'color' => 'info',
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                'value' => BookingStatusEnum::PAID->value,
                'name_ru' => 'Оплачен',
                'name_en' => 'Paid',
                'color' => 'success',
                'created_at' => now(),
            ...
            [
                'value' => BookingStatusEnum::PARTIALLY_PAID->value,
            ...
            [
                'value' => BookingStatusEnum::REFUND_NO_FEE->value,
            ...
            [
                'value' => BookingStatusEnum::REFUND_FEE->value,
