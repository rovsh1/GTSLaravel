...
*Сравнение $a != $b возвращает FALSE, но на самом деле это TRUE! Строка 42 отличается от строки числа 42.*
...
> Если у вас несколько уровней абстракции, то на функцию возложено слишком много задач.
